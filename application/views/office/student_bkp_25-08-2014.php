<?php if ($class_id != ""): ?>
 ...
 <a  data-toggle="modal" href="#modal-form" onclick="modal('student_promote',<?php echo $row['student_id'];?>,<?php echo $class_id;?>)" class="btn btn-default btn-small">

                                            <i class="icon-user"></i> <?php echo get_phrase('promote');?>
