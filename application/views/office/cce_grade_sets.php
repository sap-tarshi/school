				...
				<table cellpadding="0" cellspacing="0" class="table responsive" border='1' >
                    ...
                    <tbody>
                        ...
                        <tr >
							...
							<form action="<?php base_url() ?>index.php?admin/cce_grade_sets/up_date_sets/" method="post">
							<td>	
								...
								<div class="row-fluid">                        
									...
									<div class="control-group">
										<div class="controls">
											...
											<a data-toggle="modal" id="<?php echo $count.'4'; ?>" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/cce_grade_sets/set_delete/<?php echo $row['set_id'];?>')" class="btn btn-red btn-small">
...
function check_gradeset_edit(p,rows)
{
 ...
 $('#grade_set_name').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/sets_dynamic_data/',
