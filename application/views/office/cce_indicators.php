<div class="box">
	...
	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php base_url() ?>index.php?admin/cce_indicators/create/">
                        <div class="row-fluid">
                        <div class="span5">
                        <div class="control-group">
                ...
                <table cellpadding="0" cellspacing="0" border="1" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<form action="<?php base_url() ?>index.php?admin/cce_indicators/up_date/" method="post">																			
								...
								<div class="row-fluid">                        
									...
									<div class="control-group">
										<div class="controls">
											...
											<a data-toggle="modal" id="<?php echo $count.'4'; ?>" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/cce_indicators/delete/<?php echo $row['indicator_id'];?>')" class="btn btn-red btn-small">
...
$('#category_name').on('change',function(){
	...
	$('#val_fc_id').append('<img title="<?php echo base_url(); ?>template/images/loading.gif" src="<?php echo base_url(); ?>template/images/loading.gif">');
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/cce_parent_indicators/',
