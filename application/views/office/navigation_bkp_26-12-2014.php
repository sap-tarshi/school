...
<div class="primary-sidebar" id="tam-custom-sidebar">
	...
	<!------sms--------->
		...
		<li class="dark-nav <?php if($page_name == 'sms_view' || $page_name == 'sms_template_view' || $page_name == 'sent_sms' ||  $page_name == 'email' ||  $page_name == 'email_view' || $page_name == 'noticeboard')echo 'active';?>">
			<span class="glow"></span>
            ...
            <ul id="communication_submenu" class="collapse <?php if($page_name == 'sms_view' || $page_name == 'sms_template_view' || $page_name == 'sent_sms' ||  $page_name == 'email' ||  $page_name == 'email_view' || $page_name == 'noticeboard')echo 'in';?>">
...
<!--		<li class="<?php if($page_name == 'parent')echo 'dark-nav active';?>">
        ...
        <li class="dark-nav <?php if(	$page_name == 'subject' ||  $page_name == 'class' ||  $page_name == 'exam' ||  $page_name == 'marks' || $page_name == 'attendence' || $page_name == 'grade' || $page_name == 'timetable_category'|| $page_name == 'departments'|| $page_name ==  'daily_attendence' || $page_name ==  'daily_attendence_view')echo 'active';?>">
			<span class="glow"></span>
            ...
            <ul id="academics_submenu" class="collapse <?php if(	$page_name == 'subject' ||  $page_name == 'class' ||  $page_name == 'exam' ||  $page_name == 'marks' || $page_name == 'attendence' || $page_name == 'grade'|| $page_name == 'timetable_category'|| $page_name == 'departments'|| $page_name ==  'daily_attendence' || $page_name ==  'daily_attendence_view') echo 'in';?>">
        ...
        <li class="dark-nav <?php if(	$page_name == 'feecategories' ||  $page_name == 'feeperiods' ||  $page_name == 'feecollect' ||  $page_name == 'feereporting')echo 'active';?>">
			<span class="glow"></span>
            ...
            <ul id="payment_submenu" class="collapse <?php if(	$page_name == 'feecategories' ||  $page_name == 'feeperiods' ||  $page_name == 'feecollect' ||  $page_name == 'feereporting') echo 'in';?>">
                    <!------invoice----->
                    ...
                    <!------Fees category----->
                    <li class="<?php if($page_name == 'feeperiods')echo 'dark-nav active';?>">
                        <span class="glow"></span>
