		...
		<div class="tab-content">            
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/timetable_category/delete/<?php echo $timetable_categories_list['timetable_category_id'];?>')" class="btn btn-red btn-small">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('admin/timetable_category/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
			...
			<div class="tab-pane box" id="add_timetable" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('admin/timetable/create' , array('class' => 'form-horizontal validatable','enctype' => 'multipart/form-data','target'=>'_top'));?>
                        <div class="padded">
                        <div class="control-group">
            ...
            <!----TABLE LISTING STARTS--->
            <div class="tab-pane box" id="timetablelist">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/timetable/delete/<?php echo $timetable_view_list['timetable_id'];?>')" class="btn btn-red btn-small">
                                		<i class="icon-trash"></i> <?php echo get_phrase('delete');?>
                                </a>
        					</td>
                        </tr>
