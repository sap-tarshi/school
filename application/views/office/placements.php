	...
	<div class="box-content padded">
    	...
    	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php base_url() ?>index.php?admin/placementinsert">
                        <div class="row-fluid">
                        <div class="span6">
            	    ...
            	    <table class="table table-bordered">
                            ...
                            <?php if(!empty($placement_data)) { foreach($placement_data as $placement_data_view) { ?>
                            	<tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>index.php?admin/placementedit/<?php echo $placement_data_view->placement_id ?>">Edit</a></td>
                                    <td><a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/placementdelete/<?php echo $placement_data_view->placement_id ?>')">Delete</a></td>
                                </tr>
                            <?php } } ?>    
                            </tbody>
                    </table>
