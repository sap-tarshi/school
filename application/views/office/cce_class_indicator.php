        ...
        <div class="span12" style="float:none !important;">
            ...
            <div class="box">
                ...
                <div class="box-content padded tam-custom-border1">
                    ...
                    <br />					
                    <select name="class_id" onchange="window.location='<?php echo base_url(); ?>index.php?admin/cce_class_indicator/'+this.value">
	...
	<div class="box-content padded">
		<div class="tab-content">            
            ...
            <div class="tab-pane box active" id="list">				
				<form action="<?php base_url() ?>index.php?admin/cce_class_indicator/<?php echo $class_id; ?>/update/" method="post">
