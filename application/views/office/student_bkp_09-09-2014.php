                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="mother_first_name" placeholder="First Name"/>
                                    <input type="text" class="validate[required]" name="mother_last_name" placeholder="Last Name" />
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="parent_email" placeholder="Parent Tam Username" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="parent_password" placeholder="Parent Tam Password" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="parent_phone2" placeholder="Parent Phone2"  />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="roll" placeholder="Roll Num"/>
