<div class="tab-pane box active" id="edit" style="padding: 5px">
				...
				<?php foreach($edit_data as $row):?>
                	<?php echo form_open('office/student/do_update'.$class_id.'/do_update/'.$row['student_id'] , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="admission_number" id="admission_number" placeholder="Please enter admission number" value="<?php echo $row['admission_number']; ?>" />
									<span id=""></span>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up validate[required]" name="doj" placeholder="Date of joining" value="<?php echo $row['doj'];?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="height" placeholder="Height" value="<?php echo $row['height'];?>" />
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="weight" placeholder="Weight" value="<?php echo $row['weight'];?>" />
                            ...
                            <!-- <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="fill-up validate[required]" name="passport_number" placeholder="Passport Number" value="<?php echo $row['passport_number'];?>"/>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up validate[required]" name="date_of_issue" placeholder="Date of Issue" value="<?php echo $row['date_of_issue'];?>"/>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up validate[required]" name="date_of_expiry" placeholder="Date of Expiry" value="<?php echo $row['date_of_expiry'];?>"/>
