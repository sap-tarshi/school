            ...
            <div class="span5" style="float:none !important;">
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        ...
                        <span class="title"> <i class="icon-info-sign"></i> Please select a Class &  Account Type to send Email.</span>
...
//                                });
                                ...
                                $(document).change('#account_selector',function(){
                                    ...
                                    if(account_type !=''){
                                        ...
                                        window.location ='<?php echo base_url(); ?>index.php?admin/email_view/'+account_type;
