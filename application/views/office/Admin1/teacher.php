            ...
            <div class="box">
                ...
                <div class="box-content padded tam-custom-border1">
                   ...
                   <center>
                    ...
                    <select name="department_id" onchange="window.location='<?php echo base_url(); ?>index.php?principal/teacher/'+this.value">
    ...
    foreach ($departments as $row):
		...
		<div class="tab-content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?principal/teacher/delete/<?php echo $row['teacher_id'];?>')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('principal/teacher/create' , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                    <form method="post" action="<?php echo base_url();?>index.php?principal/teacher/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="email" id="teacher_uname_val" placeholder="official Username"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="password" placeholder="official Password"/>
