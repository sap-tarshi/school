		...
		<div class="tab-content">
            ...
            <div class="tab-pane box <?php if(!isset($edit_data))echo 'active';?>" id="list">
                ...
                <div class="box-content">
                	<?php echo form_open('principal/sms_view/'.$class_id.'/send_group_sms' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                          
                          
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('sms_to');?></label>
                                <div class="controls">
...
<!----CREATION FORM STARTS---->
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('principal/sms_view/'.$class_id.'/send_template_sms' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                        ...
                        ?>
                            <option value="<?php echo $row['sms_template_id'];?>"
                            	<?php if($class_id == $row['sms_template_id'])echo 'selected';?> >
                                	<?php echo $row['sms_template_content'];?></option>
                        <?php
                        endforeach;
                        ?>
                    </select>
                         ...
                         <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('sms_template_to');?></label>
                                <div class="controls">
...
<div class="span4" style="float:none !important;">
    <div class="box">
		...
		<div class="box-content padded tam-custom-border1">
            <br />
            <select name="class_id" onchange="window.location='<?php echo base_url();?>index.php?principal/sms_view/'+this.value">
