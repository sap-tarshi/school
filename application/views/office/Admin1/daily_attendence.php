...
<script type="text/javascript">
 ...
 function getAttendenceView(){
	 ...
	 document.daily_attendence_frm.action = "<?php echo base_url() ?>index.php?principal/daily_attendence_reason";
...
$('.da_mod_cls').on('click',function(){
	...
	var adtype = $(this).data('ad-type');
	 ...
	 $.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/daily_attn_update',
