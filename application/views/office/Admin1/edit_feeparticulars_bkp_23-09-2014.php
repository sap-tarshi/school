	...
	<div class="box-content padded">
    	...
    	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php base_url() ?>index.php?admin/fee_particular_update">
                        ...
                        <div id="custom-tam-fp-type-blck">
                            ...
                            <?php } else if ($fee_particular_type =='fp_roll') { ?>
                                ...
                                <?php $values = explode(',', $fee_particular_type_id); if( in_array($fp_roll_data_view->roll, $values)) { ?> 
								<label class="checkbox inline"><input type="checkbox" id="fee_particular_type_id<?php echo $fp_roll_data_view->roll ?>" name="fee_particular_type_id[]" value="<?php echo $fp_roll_data_view->roll ?>" checked='checked'><?php echo $fp_roll_data_view->name.'-'.$fp_roll_data_view->roll ?></label>
                              <?php } else {?>   
                              
                              <label class="checkbox inline"><input type="checkbox" id="fee_particular_type_id<?php echo $fp_roll_data_view->roll ?>" name="fee_particular_type_id[]" value="<?php echo $fp_roll_data_view->roll ?>"><?php echo $fp_roll_data_view->name.'-'.$fp_roll_data_view->roll ?></label>
...
$('#fee_particular_name').on('change',function(){
	...
	$('#val_fp_val').append('<img title="<?php echo base_url(); ?>template/images/loading.gif" src="<?php echo base_url(); ?>template/images/loading.gif">');
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/fee_particular_check/',
