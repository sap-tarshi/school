		...
		<div class="tab-content">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive box">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	<a data-toggle="modal" href="<?php echo base_url();?>index.php?principal/editbooks/<?php echo $row['ebooks_id'];?>" <?php /*?>onclick="modal('edit_book',<?php echo $row['ebooks_id'];?>)"<?php */?> class="btn btn-gray btn-small">
                                		<i class="icon-wrench"></i> <?php echo get_phrase('edit');?>
                                </a>
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?principal/ebooks/delete/<?php echo $row['ebooks_id'];?>')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('principal/ebooks/create' , array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data', 'target'=>'_top'));?>
                        <div class="padded">
