...
<div class="box-content padded">
  <div class="tab-content"> 
    ...
    <div class="tab-pane box" id="add" style="padding: 5px">
      <div class="box-content"> <?php echo form_open('principal/transport/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
        <div class="padded">
    ...
    <div class="tab-pane box" id="addstnd" style="padding: 5px">
      <div class="box-content"> <?php echo form_open('principal/transport/assign_student' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
        <div class="padded">
          <div class="control-group">
            <label class="control-label"><?php echo get_phrase('route_name');?></label>
            <div class="controls">
...
$('#route_id').on('change',function(){
	...
	if(rid!=''){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/getpoints/',
							data: { route_id:rid },
 ...
 $('#class_id').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/ppnt_stn_data/',
  ...
  $('#rdata_id').on('change',function(){
	  ...
	  $.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/get_route_data/',
							data: { route_id:rdid },
							success: function(data) {
