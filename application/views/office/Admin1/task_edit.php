...
<div class="box">
	...
	<div class="box-content padded">
        ...
        <div class="pull-right custom-tam-table-btns">
                    	...
                    	<a href="<?php echo base_url() ?>index.php?principal/tasks" class="btn btn-small btn-lightblue"><?php echo get_phrase('view_things');?></a>
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                        ...
                        <?php echo form_open('principal/taskupdate' , array('class' => 'form-horizontal validatable'));?>
