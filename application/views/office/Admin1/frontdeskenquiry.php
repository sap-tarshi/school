		...
		<div class="tab-content">
            ...
            <div class="tab-pane  active" id="list">
                    ...
                    <div class="box">
                      ...
                      <form method="post" action="<?php echo base_url();?>index.php?principal/frontdeskenquiry/" class="form-horizontal validatable" enctype="multipart/form-data" name="getfrm">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	 <form method="post" action="<?php echo base_url();?>index.php?principal/frontdeskenquiry/create/" class="form-horizontal validatable" enctype="multipart/form-data">
