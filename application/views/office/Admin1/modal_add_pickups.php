...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
      <?php echo form_open('principal/transport/add_pickups/'.$route_id , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
...
$('.btn-rm-ppoint').on('click',function(){
	...
	if (r == true) {
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/del_tpoint/',
							data: { pid_val:pid  },
