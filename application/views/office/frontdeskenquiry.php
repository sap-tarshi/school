		...
		<div class="tab-content">
            ...
            <div class="tab-pane  active" id="list">
                    ...
                    <div class="box">
                      ...
                      <form method="post" action="<?php echo base_url();?>index.php?admin/frontdeskenquiry/" class="form-horizontal validatable" enctype="multipart/form-data" name="getfrm">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	 <form method="post" action="<?php echo base_url();?>index.php?admin/frontdeskenquiry/create/" class="form-horizontal validatable" enctype="multipart/form-data">
...
<script>
	...
	$('#emp_code_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/schcodecheck/',
							data: { chkcode:tcode },
	...
	$('#staff_uname_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/schemailcheck/',
							data: { chkmail:temail },
							success: function(data) {
								//alert(data);
	...
	$('#staff_email_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/schtemailcheck/',
							data: { chkmail:temail },
							success: function(data) {
								//alert(data);
