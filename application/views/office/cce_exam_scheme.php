                ...
                <center>
                  <div class="box">
                    ...
                    <div class="box-content padded tam-custom-border1"> <br />
                      <select name="class_id" onchange="window.location='<?php echo base_url(); ?>index.php?admin/examscheme/'+this.value">
...
$(document).on('click','#adtstbtn',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?admin/cce_add_test_data',
...
$(document).on('click','#del-test',function(){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?admin/cce_del_test_data',
			data:{ t_id : tid },
			success: function(data) {
