<div class="box">
	...
	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php base_url() ?>index.php?admin/cce_assessment/create/">
                        <div class="row-fluid">
                        <div class="span5">
                        <div class="control-group">
                ...
                <table cellpadding="0" cellspacing="0" border="1" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<form action="<?php base_url() ?>index.php?admin/cce_assessment/up_date/" method="post">	
								...
								<div class="row-fluid">                        
									...
									<div class="control-group">
										<div class="controls">
											...
											<a data-toggle="modal" id="<?php echo $count.'4'; ?>" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/cce_assessment/delete/<?php echo $row['assessement_id'];?>')" class="btn btn-red btn-small">
