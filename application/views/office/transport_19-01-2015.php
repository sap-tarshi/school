...
<?php	if($this->session->userdata('academic_year')==""){ ?>
	<select id="change_academic_year" name="change_academic" onchange="window.location='<?php echo base_url(); ?>index.php?admin/transport/'+this.value">
		<option value="">Academic Year</option>
		<option value="1" <?php if($this->session->userdata('academic_year')=='2014-2015'){echo 'selected';} ?>>2014-2015</option>
		<option value="2" <?php if($this->session->userdata('academic_year')=='2015-2016'){echo 'selected';} ?>>2015-2016</option>
	</select>
	<?php }else{ ?>
<div class="box">
...
<select id="change_academic_year" name="change_academic" onchange="window.location='<?php echo base_url(); ?>index.php?admin/transport/'+this.value">
		<option value="">Academic Year</option>
		<option value="1" <?php if($this->session->userdata('academic_year')=='1'){echo 'selected';} ?>>2014-2015</option>
		<option value="2" <?php if($this->session->userdata('academic_year')=='2'){echo 'selected';} ?>>2015-2016</option>
	</select>  
...
$('#route_id').on('change',function(){
 ...
 $('#class_id').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/ppnt_stn_data/',
  ...
  $('#rdata_id').on('change',function(){
	  ...
	  $.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/get_route_data/',
							data: { route_id:rdid },
							success: function(data) {
