        ...
        <div class="box-content">
            ...
            <div class="tab-content">
               ...
               <div class="tab-pane <?php if(isset($upload)) { echo 'active'; } ?>" id="upload">
                   <?php echo $error;?>
           <?php echo form_open_multipart('office/student/do_upload/'); ?>
...
margin-top: 25px;" align="center">
                ...
                <div class="tab-pane <?php if(!isset($upload)) { echo 'active' ;}  ?>" id="list">
                    ...
                    <center class="custom-tam-cng-sel-block">
                       ...
                       <span> Change Class </span>
                        ...
                        <select name="class_id" onchange="window.location='<?php echo base_url(); ?>index.php?office/student/'+this.value">
    ...
    ?>
						 ...
						 <td valign="top"><input class="btn btn-green btn-small" type="submit" value="Bulk Promote" name="bulk-promote">
                          ...
                          <input type="hidden" value="<?php echo $class_id ?>" name="p_class"  />
						 </td>
						 </tr>
			...
			<?php /******************************************************************************************************/ ?>			 
					...
					<th class="check_box"><div><input type="checkbox" name="select_all" class="select_all" value="<?php echo $size ?>" id="select_all"></div></th>
                                        ...
                                        <th><div style="width:160px;"><?php echo get_phrase('username'); ?></div></th>
        ...
        foreach ($students as $row): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td ><div style="width:160px;"><?php echo $row['parent_email']; ?></div></td>
                                                    ...
                                                    <td align="center">
                                                       ...
                                                       <div class="custom-tam-table-btns">
                                                            <!--<a data-toggle="modal" href="javascript:;" class="btn btn-lightblue btn-small custom-tam-indsudsms" data-studentid="<?php echo $row['student_id']; ?>" data-stype="sms"><i class="icon-mobile-phone"></i> SMS </a>-->
                                                                    ...
                                                                    <div class="custom-tam-table-btns">
                                                                        <!--<a  data-toggle="modal" href="javascript:;" class="btn btn-lightblue btn-small custom-tam-indsudsms" data-studentid="<?php echo $row['student_id']; ?>" data-stype="mail"><i class="icon-envelope-alt"></i> Mail</a>-->
                                                                        ...
                                                                        <a  data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>index.php?office/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>')" class="btn btn-red btn-small">
                                                    ...
                                                    <!--<a href="<?php echo base_url(); ?>index.php?office/student/<?php echo $class_id; ?>/personal_profile/<?php echo $row['student_id']; ?>"
                                                    ...
                                                    <a href="<?php echo base_url(); ?>index.php?office/student/<?php echo $class_id; ?>/academic_result/<?php echo $row['student_id']; ?>"
                                                    ...
                                                    <a href="<?php echo base_url(); ?>index.php?office/student/<?php echo $class_id; ?>/edit/<?php echo $row['student_id']; ?>"
                                                    ...
                                                    <a href="<?php echo base_url(); ?>index.php?office/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>" onclick="return confirm('delete?')"
...
<?php $j++ ?>
    ...
    <?php echo form_open('office/student/create/', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data')); ?>
                        ...
                        <div class="padded">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="admission_number" id="admission_number" placeholder="Please enter admission number"/>
                           ...
                           <!--  <input type="hidden" name="class_id" value="<?php echo $class_id; ?>" /> -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up validate[required]" name="doj" placeholder="Date of joining"/>
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="height" placeholder="Height"/>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="weight" placeholder="Weight"/>
                            ...
                            <div class="control-group">
								...
								<div class="controls">
                                    ...
                                    <select class="uniform validate[required]" name="student_country_id">
                                     <option value="">-- Select Country --</option>
                                        <?php
                                            $classes = $this->db->get('country')->result_array();
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="fill-up validate[required]" name="passport_number" placeholder="Passport Number"/>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up validate[required]" name="date_of_issue" placeholder="Date of Issue"/>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="datepicker fill-up validate[required]" name="date_of_expiry" placeholder="Date of Expiry"/>
...
<script>
	...
	$('#student_roll_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?office/sdtrollcheck/',
	...
	$('#admission_number').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php //echo base_url(); ?>index.php?office/sdtamcheck/',
	...
	$('#student_email_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?office/sdtemailcheck/',
							data: { chkmail:semail },
							success: function(data) {
								//alert(data);
...
$('.custom-tam-indsudsms').on('click',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?office/sms_student_data',
			data: { sid:stndid },
			success: function(data) {
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?office/email_student_data',
			data: { sid:stndid },
			success: function(data) {
...
$(document).on('click','#sndsmsbtn',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?office/sms_student_snd',
...
$(document).on('click','#sndmailbtn',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?office/mail_student_snd',
			data:$( '#snd-frm' ).serialize(),
			success: function(data) {
			//alert(data)
				if(data == 'true'){
