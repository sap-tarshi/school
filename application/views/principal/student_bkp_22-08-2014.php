<?php if ($class_id != ""): ?>
    ...
    <?php echo form_open('admin/student/create/', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data')); ?>
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo get_phrase('religion/caste'); ?></label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="tam_username"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="tam_password"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="parent_tam_username"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="parent_tam_password"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <textarea name="present_address" rows="6" columns="4"></textarea>
    ...
    foreach ($classes as $row):
        ?>
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo get_phrase('occupation/income(per annum)'); ?></label>
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo get_phrase('student_phone'); ?></label>
    ...
    <?php echo form_close(); ?>                
                ...
                <div class="tab-pane box <?php if(isset($upload)) { echo 'active' ;}  ?>" id="upload" style="padding: 5px">

                   <div class="box-content">
                        <?php echo $this->session->flashdata('invalid'); ?>  
                    
                        <form action="<?php echo base_url(); ?>index.php?admin/read" id="import_student" method="post" enctype="multipart/form-data">
                            ...
                            <div class="padded">
                                ...
                                <div class="control-group">
                                    <input type="hidden" name="class_id" value="<?php echo $class_id ;?>"/>
                                      <label class="control-label"><?php echo get_phrase('Select File To Upload Student Data'); ?></label>
                                      <br/>
                                      <div class="controls" style="width:210px;">
                                          <input type="file" required class="" name="studentfile" id="student_upload" />
                                      </div>
                                 </div>
                            </div>
                            </div>
                            <div class="form-actions">
                               <button type="submit" class="btn btn-gray"><?php echo get_phrase('submit'); ?></button>
