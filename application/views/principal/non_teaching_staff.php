	...
	<div class="box-content padded">
		<div class="tab-content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?principal/staff/delete/<?php echo $row['staff_id'];?>')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('principal/staff/create' , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                    <form method="post" action="<?php echo base_url();?>index.php?principal/staff/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo get_phrase('Official username'); ?></label>
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo get_phrase('Official password'); ?></label>
...
<script>
	...
	$('#emp_code_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/schcodecheck/',
							data: { chkcode:tcode },
	...
	$('#staff_uname_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/schemailcheck/',
							data: { chkmail:temail },
							success: function(data) {
								//alert(data);
	...
	$('#staff_email_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/schtemailcheck/',
							data: { chkmail:temail },
							success: function(data) {
								//alert(data);
