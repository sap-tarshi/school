...
<div class="box">
	<div class="box-header">
		...
		<ul class="nav nav-tabs nav-tabs-left">
            ...
            <li>
            	<a href="#route" data-toggle="tab"><i class="icon-plus"></i>
					<?php echo get_phrase('route_data');?>
                    	</a></li>
                        
            <li>
            	<a href="#addstnd" data-toggle="tab"><i class="icon-plus"></i>
					<?php echo get_phrase('add_students');?>
                    	</a></li>
	...
	<div class="box-content padded">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                                ...
                                <a data-toggle="modal" href="#modal-form" onclick="modal('add_pickups',<?php echo $row['transport_id'];?>)" class="btn btn-gray btn-small">
                                		<i class="icon-wrench"></i> <?php echo get_phrase('add/view_pickups');?>
                                </a>
    	...
    	<div class="row-fluid form-horizontal">
			...
			<div class="tab-pane box" id="addstnd" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('admin/transport/assign_student' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('route_name');?></label>
                                <div class="controls">
