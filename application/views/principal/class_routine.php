                                                    ...
                                                    <td>
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu">
																...
																<li><a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?principal/class_routine/delete/<?php echo $row2['class_routine_id'];?>')">
