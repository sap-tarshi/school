	<div id="custom-tam-principal-dashboard">
		...
		<div class="row-fluid">
                             ...
                             <a href="<?php echo base_url();?>index.php?principal/staff">
                               ...
                               <a href="<?php echo base_url();?>index.php?principal/tasks">
                            	...
                            	<div class="cstm-dboard-blck bg-deep-red">
                                 ...
                                 <a href="<?php echo base_url();?>index.php?principal/daily_attendence">
                            	<div class="cstm-dboard-blck bg-light-blue">
                           		...
                           		<a href="<?php echo base_url();?>index.php?principal/daily_staffattendence">
                            	<div class="cstm-dboard-blck bg-block-purple">
                                	<div><i class="fa fa-check-square-o fa-4x"></i></div>
                            	...
                            	<div class="cstm-dboard-blck bg-light-purple">
                                	<div><i class="fa fa-flag-o fa-4x"></i></div>
                                	<div><?php echo get_phrase('SMS');?></div>
                                </div>
                                </a>
			</div>
</div>
			...
			<div class="span30">
				...
				<!--big normal buttons-->
						...
						<!--<div class="span2">
							<a href="<?php echo base_url();?>index.php?principal/frontdeskenquiry">
                    ...
                    <div class="row-fluid">
						<!---<div class="span2 ">
							<a href="<?php echo base_url();?>index.php?principal/dormitory">
						...
						<!--<div class="span2 ">
							<a href="<?php //echo base_url();?>index.php?principal/parent">
					...
					<div class="row-fluid">
						...
						<!--<div class="span2 ">
							<a href="<?php echo base_url();?>index.php?principal/ebooks">
						...
						<div class="span2 ">
							<a href="<?php echo base_url();?>index.php?principal/previousquestionpapers">
						...
						<div class="span2 ">
                            <a href="<?php echo base_url();?>index.php?principal/onlinetest">
                            <img src="http://www.schoolbookpro.com/tamimages/adminimages/ebooks.png" height="80px" width="80px"/><br />
						...
						<!--<div class="span2 ">
							<a href="<?php echo base_url();?>index.php?principal/placements">
