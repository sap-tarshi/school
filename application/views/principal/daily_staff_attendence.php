<div class="box">
		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	...
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					...
					<?php echo get_phrase('manage_daily_staff_attendence');?>
	...
	<div class="box-content padded">
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <?php $attributes = array('name' => 'daily_attendence_frm'); echo form_open('principal/daily_staff_attendence_view', $attributes);?>

                <table border="0" cellspacing="0" cellpadding="0" class="table table-normal box">

                	<tr>

                        <td><?php echo get_phrase('staff_cetegory');?></td>
                	...
                	<tr>
                        ...
                        <td>
                        	...
                        	<select name="class_id" id="class_id" class=""   style="float:left;">
                                ...
                                <option value=""><?php echo get_phrase('staff_cetegory');?></option>
        ...
        <table class="table table-normal box" >
                   ...
                   <tbody>
                        ...
                        <tr>
                            ...
                            <th><?php echo get_phrase('Employee Id');?></th>
...
<script type="text/javascript">
 ...
 function getAttendenceView(){
	 ...
	 document.daily_attendence_frm.action = "<?php echo base_url() ?>index.php?principal/daily_staffattendence_reason";
...
$('.da_mod_cls').on('click',function(){
	...
	var adtype = $(this).data('ad-type');
	 ...
	 $.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/staffdaily_attn_update',
...
$('#custom-tam-ssmsa').on('click',function(e){
	...
	else
	{
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/daily_attn_count',
...
$(document).on('click','#sms-tam-absenties',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/sendsmsabsenties',
							data: { smscid:smsclassid ,smsdt:smsdate },
							success: function(data) {
