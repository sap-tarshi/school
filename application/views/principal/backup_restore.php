	...
	<div class="box-content padded">
		<div class="tab-content">            
                    ...
                    <tbody>
						...
						for($i = 1; $i<= 15; $i++):
							...
							<tr>
								...
								<td align="center">
									<a href="<?php echo base_url();?>index.php?principal/backup_restore/create/<?php echo $type;?>" 
										class="btn btn-gray" rel="tooltip" data-original-title="download backup"><i class="icon-download-alt" ></i>
											Download Backup</a>
									<a href="<?php echo base_url();?>index.php?principal/backup_restore/delete/<?php echo $type;?>" 
            ...
            <div class="tab-pane box  span6" id="restore">
				<?php echo form_open('principal/backup_restore/restore' , array('enctype' => 'multipart/form-data'));?>
