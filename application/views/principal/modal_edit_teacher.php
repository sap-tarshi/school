<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('principal/teacher/do_update/'.$row['teacher_id'] , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
...
$('#emp_code_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/tchcodecheck/',
...
$('#teacher_uname_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/tchemailcheck/',
	...
	$('#teacher_email_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/tchtemailcheck/',
							data: { chkmail:temail, prevmail:ptemail  },
							success: function(data) {
								//alert(data);
