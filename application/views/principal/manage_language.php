		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
						...
						echo form_open('principal/manage_language/update_phrase/'.$current_editing_language  , array('id' => 'phrase_form'));
						$count = 1;
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-normal">
                    ...
                    <tbody>
                    	...
                    	<tr>
                        	...
                        	<td>
                            	<a href="<?php echo base_url();?>index.php?principal/manage_language/edit_phrase/<?php echo $field;?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit_phrase');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?principal/manage_language/delete_language/<?php echo $field;?>"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('principal/manage_language/add_phrase/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
			...
			<div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('principal/manage_language/add_language/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
