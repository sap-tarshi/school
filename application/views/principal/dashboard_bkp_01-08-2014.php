				...
				<div class="action-nav-normal">
					...
					<div class="row-fluid">
						...
						<div class="span2 ">
							...
							<img src="<?php echo base_url();?>template/images/icons/exams.png" height="80px" width="80px"/><br />
							<span><?php echo get_phrase('Exam');?></span>
							</a>
						</div>
						<div class="span2 ">
							<a href="<?php echo base_url();?>index.php?admin/classes">
							<img src="<?php echo base_url();?>template/images/icons/class.png" height="80px" width="80px"/><br />
