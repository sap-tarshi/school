                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?principal/sms_template_view/delete/<?php echo $row['sms_template_id'];?>')" class="btn btn-red btn-small">
...
<!----CREATION FORM STARTS---->
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('principal/sms_template_view/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
