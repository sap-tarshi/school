		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content padded">
                   ...
                   <?php endif;?>  
                        <form method="post" action="<?php echo base_url();?>index.php?principal/sendmailsms" class="form-horizontal validatable">
...
$('.cstm-rtype').on('click',function(){
	...
	if(rtype == 3 || rtype == 2 ){
		...
		$.ajax({
						type: 'POST',
						url: '<?php echo base_url(); ?>index.php?principal/getClass/',
