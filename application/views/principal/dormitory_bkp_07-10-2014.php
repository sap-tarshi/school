                	...
                	<?php echo form_open('admin/dormitory/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" placeholder="Hostel Name" name="name"/>
                                </div>
                            </div>
                            <!--
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" class="No of Rooms" name="number_of_room"/>
                                </div>
                            </div>
                            -->
                            <div class="control-group">
