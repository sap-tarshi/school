                    ...
                    <tbody>
                        ...
                        <tr>
                           <td><?php echo $count++;?></td>
                            ...
                            <td align="center">
                            	<a data-toggle="modal" href="<?php echo base_url()."index.php?admin/viewpoll/".$rows->poll_id?>" class="btn btn-gray btn-small">
                                		<i class="icon-wrench"></i> <?php echo get_phrase('View');?>
                                </a>
                            	<a data-toggle="modal" href="<?php echo base_url();?>index.php?admin/onlinetest/delete/<?php echo $rows->poll_id;?>" onclick="confirm('Do You wanto delete')"
