	...
	<div class="box-content padded">
    	...
    	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php base_url() ?>index.php?principal/fee_particular_insert">
            	    ...
            	    <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                            ...
                            <?php if(!empty($fp_data)) { foreach($fp_data as $fp_data_view) { ?>
                            	<tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>index.php?principal/fee_particular_edit/<?php echo $fp_data_view->fee_particular_id ?>" class="btn btn-small btn-lightblue"><i class="icon-edit"></i> Edit</a>  <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?principal/fee_particular_delete/<?php echo $fp_data_view->fee_particular_id ?>')" class="btn btn-small btn-red"><i class="icon-trash"></i> Trash</a></td>
                                </tr>
                            <?php } } ?>    
                            </tbody>
                    </table>
...
$('#fee_particular_name').on('change',function(){
	...
	$('#val_fp_val').append('<img title="<?php echo base_url(); ?>template/images/loading.gif" src="<?php echo base_url(); ?>template/images/loading.gif">');
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/fee_particular_check/',
...
$('#fee_particular_type').on('change',function(){
	...
	if(fp_type != '' || fp_type != 'fp_all'){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/fee_particular_type/',
...
$('.fp-roll-view').on('click',function(e){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/fee_particular_rolls/',
