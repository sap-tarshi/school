		...
		<div class="tab-content">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?principal/dormitory/delete/<?php echo $row['dormitory_id'];?>')" class="btn btn-red btn-small">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('principal/dormitory/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?principal/dormitory/delete_room/<?php echo $row['room_id'];?>')" class="btn btn-red btn-small">
                                        <i class="icon-trash"></i> <?php echo get_phrase('delete');?>
                                </a>
                            </td>
                        </tr>
            ...
            <div class="tab-pane box" id="add_room" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('principal/dormitory/create_room' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            <div class="control-group">
            ...
            <div class="tab-pane box" id="add_student" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('principal/dormitory/assign_student' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
...
<script type="text/javascript">
  ...
  $('#class_id').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/dor_stn_data/',
							data: { get_der_cid:der_cid },
  ...
  $('#dormitory_name').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/dryname_chk/',
   ...
   $('#room_name').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?principal/rmname_chk/',
