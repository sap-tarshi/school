            ...
            <div class="tab-content">
                ...
                <div class="tab-pane box <?php if (!isset($edit_data)) echo 'active'; ?>" id="list">
                    ...
                    <div class="box-content">
                        ...
                        <?php echo form_open('principal/email/' . $class_id . '/send_group_sms', array('class' => 'form-horizontal validatable', 'target' => '_top')); ?>
...
//                                });
                                ...
                                $(document).change('#account_selector',function(){
                                    ...
                                    if(account_type !=''){
                                        ...
                                        window.location ='<?php echo base_url(); ?>index.php?principal/email_view/'+account_type;
