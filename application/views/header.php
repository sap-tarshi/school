...
<div class="navbar navbar-top navbar-inverse">
	<div class="navbar-inner" id="tam-custom-navbar-top">
      ...
      <img src="<?php echo base_url(); ?>template/images/logo.png" style="width: 25px; margin-top: -8px;margin-right: 5px;" />
      <?php echo $system_name;?>
			</a>
            <ul class="nav">
                <li id="time" style="display: none"></li>
			</ul>
        ...
        <div id="google_translate_element" style="z-index: 9999;"></div>
        <script type="text/javascript">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">Select Language <b class="caret"></b></a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            ?>
                               ...
                               <?php 
                    function myEvents(){
                         $sql="select date,data from calendar where date >=  NOW() ";
                            $query =mysql_query('select date,data from calendar where date >=  NOW() limit 4 ');
                   ...
                   return $details;   
                    ...
                    <?php if(get_phrase($this->session->userdata('login_type')) == 'Admin'):?>   
                       <ul class="nav pull-right">
                            ...
                            <a href="<?php echo base_url();?>index.php?admin/calendar/calendar" ><i class="icon-calendar"></i> Calendar
                              
                          </a>
                            </li>
                            <li class="dropdown dropdown-big"> <a class="dropdown-toggle" href="#" data-toggle="dropdown"> <i class="icon-list"></i> Events </a>
          <ul class="dropdown-menu">
              <?php $details=myEvents(); ?>
          ...
          <?php } ?>
            <li style="padding:5px;">
              <div class="drop-foot" style="text-align:center;"> <a href="index.php?admin/calendar/calendar">View All</a> </div>
            </li>
            <?php } else {?>
            	  <li>
            ...
            <?php } ?>
                  ...
                  <ul class="nav pull-right">
					<li class="dropdown">
                     <?php if(get_phrase($this->session->userdata('login_type')) == 'Admin') { ?> 
                     <a href="<?php echo base_url();?>index.php?<?php echo $account_type;?>/mailsms" ><i class="icon-envelope"></i> </a>
                     <?php } else { ?>  
					<a href="<?php echo base_url();?>index.php?<?php echo $account_type;?>/email" ><i class="icon-envelope"></i><span class="badge badge-important">
                ...
                <ul class="nav pull-right">
                            <li class="dropdown">
                            <a href="<?php echo base_url();?>index.php?<?php echo $account_type;?>/tasks" ><i class="icon-bell"></i><span class="badge badge-important">
