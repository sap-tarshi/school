...
<!------manage previous papers--->
		...
		<li class="<?php if($page_name == 'Preivious question papers')echo 'dark-nav active';?>">

			<span class="glow"></span>

				<a href="<?php echo base_url();?>index.php?student/questionpaper" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'Online Test')echo 'dark-nav active';?>">

			<span class="glow"></span>

				<a href="<?php echo base_url();?>index.php?student/onlinetest" rel="tooltip" data-placement="right" 
