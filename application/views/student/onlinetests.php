...
<?php if(!empty($_POST)){ if(empty($onlinetest)){?>
	<div class="row-fluid">
    	<div class="span6 offset3">
            ...
            <p>
            <a href="<?php base_url();?>index.php?student/onlinetest" class="btn btn-info btn-small">Go Back</a>
            </p>
            </div>
        </div>
    </div>
...
<a href="<?php base_url();?>index.php?student/onlinetest" class="btn btn-danger btn-small">Yes</a>
</div>
</div>
