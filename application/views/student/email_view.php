                                       ...
                                       <tr>
                                        ...
                                        <td align="center" width="200px;">
                                            <a data-toggle="modal" href="#modal-form" onclick="modal('email_body',<?php echo $row['id'];?>)"
                                             ...
                                             <a  data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>index.php?student/email_delete/<?php echo $row['id']; ?>')" class="btn btn-red btn-small">
