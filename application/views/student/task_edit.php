...
<div class="box">
	...
	<div class="box-content padded">
        ...
        <div class="pull-right custom-tam-table-btns">
                    	...
                    	<a href="<?php echo base_url() ?>index.php?student/tasks" class="btn btn-small btn-lightblue"><?php echo get_phrase('view_tasks');?></a>
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                        ...
                        <?php echo form_open('student/taskupdate' , array('class' => 'form-horizontal validatable'));?>
                                <div class="control-group">
                                  ...
                                  <div class="control-group">
                                    <label class="control-label"><?php echo get_phrase('task description');?></label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <label class="control-label"><?php echo get_phrase('task status');?></label>
                                    <div class="controls">
                                ...
                                <input type="hidden" value="<?php echo $task_id;?>" name="hid_tid" id="hid_tid"  />
                            		<button type="submit" class="btn btn-lightblue"><?php echo get_phrase('add task');?></button>
                        		</div>
                        </form>
...
$( "#task_start_date,#task_end_date" ).change(function() {
		...
		if(srtDt!='' && enDt!=''){
		 $.ajax({
							type: 'POST',
							url: '<?php echo base_url() ?>index.php?student/datecompare/',
