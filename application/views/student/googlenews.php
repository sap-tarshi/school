...
<div id="rssdata">
    ...
    <div class="loading">Loading RSS items...</div>
                  ...
                  <!--   
                    <div class="row-fluid">
       					    <div class="span12 custom-news" id="news1a"></div>
                    </div>
                    <div class="row-fluid">
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $(data.responseData.feed.entries).each(function (index, entry) {
                /*var item_html = '<li class="line_style"><a target="_blank" href="' + entry.link + '"><strong>' + entry.title + '</strong><p>'+entry.contentSnippet+'</p>'+entry.content+'</a></li>';*/
                //var item_html = entry.content;
                $('#rssdata div.rss-items').append(entry.content);
            });
            $('#rssdata div.loading').fadeOut();
            //$('#rssdata div.rss-items').slideDown();
        },
        error: function () {}
