                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?teacher/leavemanagement/delete/<?php echo $row['leave_id'];?>')" class="btn btn-red btn-small">
...
$('#leave_type').on('change',function(){
	...
	if(ltype !=''){
		 $.ajax({
							type: 'POST',
							url: '<?php echo base_url() ?>index.php?teacher/ltypedata/',
							data: { lType:ltype  },
...
$( "#lstartDate,#lendDate" ).change(function() {
		...
		if(srtDt!='' && enDt!=''){
		 $.ajax({
							type: 'POST',
							url: '<?php echo base_url() ?>index.php?teacher/datecompare/',
							...
							success: function(data) {
								...
								if(data=='false'){
								 ...
								 $.ajax({
												type: 'POST',
												url: '<?php echo base_url() ?>index.php?teacher/caldays/',
												data: { startDate:srtDt ,endDate:enDt },
												success: function(data) {
