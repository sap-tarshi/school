	...
	<div class="box-content padded">
		<div class="tab-content">
            ...
            <div class="tab-pane box <?php if(!isset($edit_data))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="teacher_books responsive">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
...
$(document).ready(function(){
   ...
   var html = $('.dataTables_filter').html();
   html = html.replace('Search', 'Search Books');
   $('.dataTables_filter').val('Search Books: '); 
   $('.dataTables_filter input').css('border','6px solid #EAEDF1');
});
</script>