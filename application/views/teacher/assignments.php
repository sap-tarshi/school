		...
		<div class="tab-content">
            ...
            <div class="controls">
                <label class="control-label">
									<input type="radio" onclick="displayDateApplicable()" class="uniform validate[required]" name="applicable"/>
									<?php echo get_phrase(' applicable');?></label><label class="control-label">
										<input type="radio" onclick="displayDateNot()" class="uniform validate[required]" name="applicable"/><?php echo get_phrase(' not_applicable');?></label>
            </div>
              </div>
...
$('#fee_period_cid').on('change',function(){
	...
	$('#val_fc_id').append('<img title="<?php echo base_url(); ?>template/images/loading.gif" src="<?php echo base_url(); ?>template/images/loading.gif">');
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?teacher/assignments_subjects/',
