...
<!-- Modal -->
<div id="custom-tam-model-notification-unpaid" class="modal hide fade" tabindex="-1" role="dialog">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
<h3 id="custom-tam-mode">Send Notification to Unpaid Members</h3>
</div>
<div class="modal-body">
<div id="custom-tam-model-body-notification-unpaid">Test</div>
</div>
<hr />
<div class="modal-footer">
<button class="btn btn-success btn-small" data-dismiss="modal" aria-hidden="true">Close</button>
...
<!-- Modal -->
<div id="custom-tam-model-ticket" class="modal hide fade" tabindex="-1" role="dialog">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
<h3 id="custom-tam-mode">Submit Your Ticket</h3>
</div>
<div class="modal-body">
<div><a href="http://tammanager.com/smstickets" target="_blank" class="btn btn-info">Click Me</a>
<p>and please login with following details </p>
<p>Username : <span>admin@tam.com</span></p>
