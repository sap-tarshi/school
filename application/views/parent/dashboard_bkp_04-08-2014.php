            ...
            <div class="span6">
				<div class="box" style="border-style: solid;border-width: 3px;border-color:#1E2529">
					...
					<div class="box-content scrollable" style="max-height: 500px; overflow-y: auto">
                    	...
                    	<?php 
						$assignments = $this->db->query('SELECT * FROM assignments WHERE class_id = (SELECT class_id FROM student WHERE student_id = ( SELECT student_id FROM parent WHERE parent_id ='.$this->session->userdata('parent_id').' ) )')->result_array();
