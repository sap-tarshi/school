        ...
        <div class="row-fluid">
			<div class="span6 offset3">
                ...
                <div style="margin-bottom:20px;">
                    ...
                    <?php if($ad_flag == 'P') { ?>
                	<div class="alert alert-success" role="alert">your child pretend school today</div>
                    
                    <?php } else if($ad_flag == 'A') { ?>
                    
                    <div class="alert alert-warning" role="alert">your child absent school today <?php if($reason_for_absent == '') { ?><a href="#tamadmodel" role="button" class="" data-toggle="modal">please submit reason here </a> <?php } else { echo "Reason : ".$reason_for_absent; } ?></div>
