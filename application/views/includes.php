<link rel="stylesheet" href="<?php echo base_url();?>template/css/font.css">
        ...
        <link href="<?php echo base_url();?>template/css/tamsms.css" media="screen" rel="stylesheet" type="text/css" />
        ...
        <![endif]-->
        <script src="<?php echo base_url();?>template/js/tamsms.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>template/js/bootstrap-tagsinput.js" type="text/javascript"></script>
        <?php
