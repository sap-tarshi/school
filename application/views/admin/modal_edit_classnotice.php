<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open('admin/classnoticeboard/do_update/'.$row['notice_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
            <div class="padded">
                       ...
                       <!-- <input type="text" class="validate[required]" name="notice_class" value="<?php echo $row['notice_class'];?>"/>-->
                        ...
                        <select class="uniform validate[required]" name="notice_class"/>
                                        ...
                                        ?>
                                            ...
                                            <option value="<?php echo $rowclass['class_id']; ?>" <?php if($rowclass['class_id'] == $row['notice_class']  ) echo "selected" ?>>

                                               <?php echo $rowclass['name'].'-'.$rowclass['name_numeric']; ?>
