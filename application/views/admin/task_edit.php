...
<div class="box">
	...
	<div class="box-content padded">
        ...
        <div class="pull-right custom-tam-table-btns">
                    	...
                    	<a href="<?php echo base_url() ?>index.php?admin/tasks" class="btn btn-small btn-lightblue"><?php echo get_phrase('view_things');?></a>
                ...
                <div class="box-content padded">
                        ...
                        <?php echo form_open('admin/taskupdate' , array('class' => 'form-horizontal validatable'));?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="datepicker fill-up validate[required]" name="task_start_date" id="task_start_date" value="<?php echo date("d/m/Y",strtotime($task_start_date)) ?>" placeholder="Please enter task start date"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo get_phrase('end date');?></label>
                                    <div class="controls">
                                        <input type="text" class="datepicker fill-up validate[required]" name="task_end_date" id="task_end_date" value="<?php echo date("d/m/Y",strtotime($task_end_date)) ?>" placeholder="Please enter task end date"/>
                                        <p id="dateError"></p>
                                    </div>
                                </div>
                                <div class="control-group">
