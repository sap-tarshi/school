                    ...
                    <tbody>
                        ...
                        <tr>							
							...
							<td align="center">
                            	...
                            	<!--<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/subject/delete/<?php echo $row['academic_id'];?>')" class="btn btn-red btn-small">
                	...
                	<?php echo form_open('admin/academicyear/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="sessionname" placeholder="Session Name"/>
                                </div>
                            </div>                        
