            ...
            <div class="span6 offset3">
                		...
                		<div id="custom-payment-block" style="display:none;">
                            ...
                            <div class="controls">
                               ...
                               <h1>&#8377; <span id="process_payment_amount_text" name="process_payment_amount_text">0</span>/-</h1>
                            ...
                            <div class="controls">
                               ...
                               <input type="text" class="span12" name="process_payment_amount_hid" id="process_payment_amount_hid" value="" />
                            ...
                            <div class="form-actions">
                                ...
                                <input type="text" name="process_payment_class_id" id="process_payment_class_id" value="" />
                                <input type="text" name="process_payment_roll_id" id="process_payment_roll_id" value="" />
                                <input type="text" name="process_payment_particular_id" id="process_payment_particular_id" value="" />
                            </div>
                        	</form>
                       	</div>
                </div>
...
$(document).on('click','.custom-fee-pay-his-btn',function(e){
	...
	$('#custom-tam-model-body-pay-his').text('');
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>index.php?admin/fee_pay_history/',
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#fee_collect_frm").validate({
			...
			submitHandler: function(form) {
				...
				$.post('<?php echo base_url(); ?>index.php?admin/fee_collect_process_data/', $("#fee_collect_frm").serialize(), function(data) {
	...
	function call_open_receipt(receipt_id){
		...
		var url = '<?php echo base_url(); ?>index.php?admin/generatereceipt/'+receipt_id;
