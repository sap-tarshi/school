                    ...
                    <?php echo form_open('admin/teacher/do_update/'.$row['teacher_id'] , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="employee_code" id="emp_code_val"  value="<?php echo $row['employee_code'];?>"/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">									
									...
									<?php $value=$this->crud_model->get_batch_all();
										foreach($value as $rows2){
										?>
											<option value="<?php echo $rows2['academic_id']; ?>" <?php if($row['employee_academicyear_id']==$rows2['academic_id']){ echo 'selected';} ?>><?php echo $rows2['session_name']; ?></option>
										<?php
										}
									?>									                                
                                    </select>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="" name="email" id="teacher_uname_val" value="<?php echo $row['email'];?>"/>
                                    <input type="hidden" id="teacher_uname_val_hid" value="<?php echo $row['email'];?>" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="teacher_email" id="teacher_email_val" value="<?php echo $row['teacher_email'];?>"/>
                                    <input type="hidden" id="teacher_email_val_hid" value="<?php echo $row['teacher_email'];?>" />
...
$('#teacher_uname_val').on('change',function(){
		...
		var temail = $(this).val();
		var ptemail = $('#teacher_uname_val_hid').val();
		...
		$.ajax({
							...
							success: function(data) {
								...
								if(data=='true'){
									...
									$("#teacher_uname_val").val(ptemail).focus();
								} else {
	...
	$('#teacher_email_val').on('change',function(){
		...
		var temail = $(this).val();
		var ptemail = $('#teacher_email_val_hid').val();
		...
		$.ajax({
							...
							success: function(data) {
								...
								if(data=='true'){
									...
									$("#teacher_email_val").val(ptemail).focus();
								} else {
