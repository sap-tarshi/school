                	...
                	<?php echo form_open('admin/exam/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" placeholder="Examination Name" name="name" id="name_val"/>
                                    <span id="val_name_img"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('date');?></label>
                                <div class="controls">
                                    <input type="text" class="datepicker fill-up" placeholder="Examination Date" name="date"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('grand_total');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" placeholder="Grand Total" name="grand_total"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('pass_mark');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" placeholder="Pass Mark" name="pass_mark"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('comment');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" placeholder="Comment" name="comment"/>
                                </div>
                            </div>
                        </div>
...
$('#name_val').on('change',function(){
    ...
    if(examname!=''){
        ...
        $('#val_name_img').removeAttr("class").text('').append('<img title="<?php echo base_url(); ?>template/images/loading.gif" src="<?php echo base_url(); ?>template/images/loading.gif">');

        $.ajax({

			type: 'POST',

			url: '<?php echo base_url(); ?>index.php?admin/examinationcheck/',

			data: { chkexam:examname},

			success: function(data) {

				if(data=='true'){

					$("#val_name_img").text('').attr("class","label label-warning").text( "Examination name '"+ examname +" ' already exists try another !" );
					...
					$("#val_name_img").removeAttr("class").text('').attr("class","label label-success").text( "Examination name '"+ examname +" ' available !" );
	    ...
	    $('#val_name_img').removeAttr("class").text('');
