                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive box">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<?php }else if($explode[1]=='xlsx' || $explode[1]=='xls'){?>
                           ...
                           <?php //echo $this->crud_model->get_image_url('previousquestionpapers', $row['books_file']); ?> <div class="avatar"></div></a></td>
							...
							<td align="center">
                            	<a data-toggle="modal" href="<?php echo base_url();?>index.php?admin/editpaper/<?php echo $row['paperid'];?>" <?php /*?>onclick="modal('edit_book',<?php echo $row['ebooks_id'];?>)"<?php */?> class="btn btn-gray btn-small">
                                		<i class="icon-wrench"></i> <?php echo get_phrase('edit');?>
                                </a>
                            	<a data-toggle="modal" href="<?php echo base_url();?>index.php?admin/previousquestionpapers/delete/<?php echo $row['paperid'];?>" onclick="return confirm('Do You wanto delete')"
