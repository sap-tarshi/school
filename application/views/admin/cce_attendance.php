                ...
                <center>
                  <div class="box">
                    ...
                    <div class="box-content padded tam-custom-border1"> <br />
                      <select name="class_id" onchange="window.location='<?php echo base_url(); ?>index.php?admin/cce_attendance/'+this.value">
  ...
  <div class="box-content padded">
    ...
    <div class="tab-content"> 
      ...
      <button class="btn btn-info tam-custom-mar-btn-10" id="max_attendance">Set Max Attendance</button>
      		...
      		<form class="form-horizontal validatable" method="post" action="<?php base_url() ?>index.php?admin/cce_attendance_ins/" >
     		<div class="" >
...
$('#max_attendance').on('click',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?admin/cce_max_attendance/gdata',
...
$(document).on('click','#updatebtn',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>index.php?admin/cce_max_attendance/udata',
