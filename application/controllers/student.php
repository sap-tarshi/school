...

{
   ...
   ****************************************************************/
    function questionpaper($param1 = '', $param2 = '', $param3 = ''){
		...
		$page_data['page_name']  = 'Preivious question papers';
    ...
    function onlinetest($param1 = '', $param2 = '', $param3 = ''){
		...
		$page_data['page_name']  = 'Online Test';
    ...
    function attendence($class_id = '', $month = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['class_id'] > 0 && $page_data['month'] > 0) {
                redirect(base_url() . 'index.php?student/attendence/' . $page_data['class_id'] . '/' . $page_data['month'], 'refresh');
            } else {
                $this->session->set_flashdata('attendence_message', 'Choose class');
                redirect(base_url() . 'index.php?student/attendence/', 'refresh');
            }
        }
