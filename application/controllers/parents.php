...
$config['next_prev_url'] = base_url().'index.php?parents/calendar/calendar';
...
//            redirect(base_url(), 'refresh');
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            $data['student_parent_email'] = $this->input->post('email');



            $this->db->where('student_id', $this->session->userdata('parent_id'));
        ...
        if ($param1 == 'change_password') {
            ...
            if ($current_password == $data['password'] && $data['new_password'] == $data['confirm_new_password']) {
                ...
                $this->db->update('student', array(
                    'parent_password' => $data['new_password']
                ));
    ...
    function attendence($class_id = '', $month = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['class_id'] > 0 && $page_data['month'] > 0) {
                redirect(base_url() . 'index.php?parents/attendence/' . $page_data['class_id'] . '/' . $page_data['month'], 'refresh');
            } else {
                $this->session->set_flashdata('parents_message', 'Choose class');
                redirect(base_url() . 'index.php?parents/attendence/', 'refresh');
            }
        }
    ...
    function email_delete($param1) {
        ...
        $this->db->update('email', $data);
        redirect(base_url() . "index.php?" . $login_type . "/email");
    }
...
$config['show_next_prev'] = TRUE;
$config['next_prev_url'] = base_url().'index.php?teacher/calendar/calendar';
        ...
        $this->load->view('parent/calendar', $data);
...
function homework($param1 = '', $param2 = '', $param3 = '') {
	...
	$page_data['class_id'] = $parent_class_id;
	$this->db->like('hw_cid',','.$parent_class_id.',');
