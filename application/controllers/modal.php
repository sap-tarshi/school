...
class Modal extends CI_Controller {
	...
	function popup($param1 = '' , $param2 = '' , $param3 = '')
	{
		...
		else if($param1	== 'edit_eventcategory')
		{
			$page_data['edit_data']	=	$this->db->get_where('event_category' , array('eventcategory_id'=>$param2))->result_array();
		}
		...
		else if($param1	== 'edit_homework')
		{	
			$this->load->model('fee_model');
    		$page_data['hw_class_data'] = $this->fee_model->getclass();	
			$page_data['edit_data']	= $this->db->get_where('homework' , array('hw_id'=>$param2))->result_array();
		}
