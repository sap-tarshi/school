...
$config['next_prev_url'] = base_url().'index.php?teacher/calendar/calendar';
...

    {
        ...
        if ($param1 == 'create') {
            ...
            $data['class_id']   = $this->input->post('class_department_id');

            $data['teacher_id'] = $this->input->post('teacher_department_id');
...

    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?teacher/assignments/', 'refresh');
    ...
    function attendence($class_id = '', $month = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['class_id'] > 0 && $page_data['month'] > 0) {
                redirect(base_url() . 'index.php?teacher/attendence/' . $page_data['class_id'] . '/' . $page_data['month'], 'refresh');
            } else {
                $this->session->set_flashdata('attendence_message', 'Choose class');
                redirect(base_url() . 'index.php?teacher/attendence/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
           ...
           */
            ...
            redirect(base_url() . 'index.php?teacher/attendence/' . $this->input->post('class_id'). '/' . $this->input->post('month') , 'refresh');
        }
...
;
...

    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?teacher/leavemanagement/', 'refresh');
